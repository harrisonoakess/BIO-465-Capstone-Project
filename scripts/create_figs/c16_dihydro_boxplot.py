...
def create_box_plot(data: pd.DataFrame, plot_name: str):
    ...
    plot_title = "C16 Dihydro Affinity Predictions for Target vs Random Proteins"
...
def main():
    ...
    ap.add_argument("--processed_csv", type=str, nargs='+', default=["confidence_predictions_pisa_c16dihydro.csv",
    ...
    create_box_plot(all_confidence_df, 'c16_dihydro_pisa_boxplot.png')
